// Loop — Create Sheet
// Audio Room is live. All other create types show "Soon" and a toast on tap.
// Non-live items deliberately do NOT navigate to prevent dead-end pages.
    ...
    if (a.live) {
      ...
      import("sonner").then(({ toast }) =>
        toast.info(`${a.label} is coming soon`, {
          description: "We're building it. Stay tuned.",
          duration: 2500,
        })
      );
    }
            ...
            return (
              <button
                ...
                className={
                  ...
                  (a.live ? "hover:bg-secondary active:scale-[0.98]" : "opacity-60 hover:opacity-80")
                }
              >
